...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    public function behaviors()
    {
        return [
            [
                ...
                'attributes' => [
                    \yii\mongodb\ActiveRecord::EVENT_BEFORE_INSERT => ['created_at', 'updated_at'],
                    \yii\mongodb\ActiveRecord::EVENT_BEFORE_UPDATE => ['updated_at'],
                ],
    ...
    public function generateUsername()
    {
        ...
        $max = $this->finder->userQuery->max('_id');
